# Gym-Application
Side project for learning purposes (mainly prisma/react) & Gym
...
## 2. Install Node.js
Install Node.js on the new computer by downloading it from [Node.js](https://nodejs.org/) if it’s not already installed.
